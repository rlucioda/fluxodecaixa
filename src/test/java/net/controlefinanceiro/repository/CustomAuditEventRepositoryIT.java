package net.controlefinanceiro.repository;

import net.controlefinanceiro.FluxodecaixaApp;
import net.controlefinanceiro.config.Constants;
import net.controlefinanceiro.config.audit.AuditEventConverter;
import net.controlefinanceiro.domain.PersistentAuditEvent;
...
import static net.controlefinanceiro.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
